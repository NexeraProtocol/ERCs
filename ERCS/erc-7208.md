...
An ODC MUST extend the functionality of [ERC-721](https://github.com/ethereum/ERCs/blob/master/ERCS/erc-721.md) through the incorporation of **Properties** in its internal storage. The **Properties** MAY have **Restrictions**.
